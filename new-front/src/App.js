...
import ListadoMP from "./pages/produccion/ListadoMP"; // En Administración, en Producción
import ProductosFabricados from "./pages/produccion/ProductosFabricados";
...
import ListadoProductosFabricados from "./pages/produccion/ListadoProductosFabricados";
import ListadoProductosFabricadosAdm from "./pages/administracion/ListadoProductosFabricadosAdm";
import DetallesPedidosProd from "./pages/produccion/DetallesPedidosProd";
import IngresosMP from "./pages/produccion/IngresosMP";
...
import AgregarCliente from "./pages/ventas/AgregarCliente";
    ...
    <div>
      <Routes>
        ...
        <Route path="/" element={<Layout area={areaEmpresa} data={datosArea} accion={setIsLoggedIn} />}>
          ...
          {/*<Route path="materias-primas/agregar" element={<ProductosFabricados />} /> Esto no va, mal*/} 
          ...
          <Route path="detalles-pedidos" element={areaEmpresa=='produccion' ? <DetallesPedidosProd /> : <DetallesPedidos />} />
